...
parser.add_argument("--train", action="store_true", help="Train on the input data.")
...
# hog (histogram of oriented gradients) - works best with CPU
# CNN (convolutional neural network) - works best on a GPU 
